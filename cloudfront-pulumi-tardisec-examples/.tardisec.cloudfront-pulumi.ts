...
export const tardisecHeaders = new aws.cloudfront.ResponseHeadersPolicy("tardisec-headers", {
  ...
  securityHeadersConfig: {
    ...
    referrerPolicy: { referrerPolicy: "no-referrer", override: false },
    strictTransportSecurity: { accessControlMaxAgeSec: 31536000, includeSubdomains: true, preload: true, override: false },
  },
  customHeadersConfig: {
    items: [
